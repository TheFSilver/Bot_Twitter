...
# code qui va twitter "Bonjour monde !"
...
# code pour streamer tous les tweets qui mentionnent tea, ou coffee
topics = ["coffee", "tea"]
...
# Code pour envoyer des DirectMessage aux personnes dans l'array "user"
user.each do |number|
  begin
  client.create_direct_message(number, text)
...
# Code pour follow les personnes dans l'array "user"
...
# code qui va twitter "Je suis élève à The Hacking Projet une formation gratuite au code et je viens de faire un bot Twitter trop cool !"
user.each do |single_user|
  begin
    client.update("#{single_user}, Je suis élève à The Hacking Projet une formation gratuite au code et je viens de faire un bot Twitter trop cool !")
    rescue Exception, NotFound, Forbidden
    next
  end
end